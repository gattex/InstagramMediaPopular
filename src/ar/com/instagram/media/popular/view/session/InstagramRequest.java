...
public class InstagramRequest {
	 ...
	 * @throws Exception If error occured.
	 */
	public String get(String requestUri, Map<String,String> params){
		Uri.Builder b = Uri.parse(requestUri).buildUpon();
		if (!"".equalsIgnoreCase(this.mAccessToken)){
			b.appendQueryParameter("access_token", mAccessToken);
		}
		...
		try {
			...
			Log.e("INSTAGRAM_POPULAR", e.getMessage());
